...
<nav class="navbar navbar-default" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-cog">&nbsp;</i>Account<b class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li><a href="#"><i class="glyphicon glyphicon-user">&nbsp;</i>Profiles</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-sort  ">&nbsp;</i>My Trade</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-plus">&nbsp;</i>My Offer</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-th">&nbsp;</i>My product</a></li>
